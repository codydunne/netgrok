 ...
 */
public class SquarifiedHostTreeMapLayout extends TreeLayout {
     ...
     */
    public SquarifiedHostTreeMapLayout(String group) {
        this(group, 0);
    }
     ...
     * @param group the data group to layout. Must resolve to a Graph instance.
     */
    public SquarifiedHostTreeMapLayout(String group, double frame) {
        super(group);
        setFrameWidth(frame);
    }
